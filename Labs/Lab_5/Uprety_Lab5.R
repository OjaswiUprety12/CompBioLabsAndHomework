  ...
  #Practiceing simple conditionals; practicing if and else statements 
x <- 4
if (x > 5) {
  print("True")
} else { 
  ...
  #Converting the data vector into a dataframe 
y <- read.csv("/Users/ojaswiuprety/Desktop/EBIO4420/CompBioLabsAndHomework/Labs/Lab_5/ExampleData.csv")
myVec <- y$x

  #Using a for loop to check each value in the imported data 
